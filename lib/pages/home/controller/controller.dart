    ...
    response.fold((failure) {
      ...
      final List<HealthModel> healthDetails = [
        ...
        HealthModel(
            ...
            title: "ANALFABETISMO", color: Color.fromARGB(255, 233, 56, 56)),
        HealthModel(
            icon: 'assets/svg/renda.svg',
            value: "R\$ ${store.rendaView.value}",
            title: "RENDA", color: Color.fromARGB(255, 36, 124, 33)),
        HealthModel(
            icon: 'assets/svg/vida.svg',
            value: "${store.espVidaView.value} %",
            title: "ESPERANÇA DE VIDA", color: Color.fromARGB(255, 236, 145, 8)),
        HealthModel(
            icon: 'assets/svg/pobre.svg',
            value: "${store.extremaProbrezaView.value}%",
            title: "EXTREMA POBREZA", color: Color.fromARGB(255, 59, 40, 230)),
      ];
